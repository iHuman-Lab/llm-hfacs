...
# ============================================================
with skip_run("run", "conditional_probabilities") as check:
    if check():
        print("[INFO] Computing conditional probabilities...")

        L4_to_L3 = conditional_probabilities(df, L4_cols, L3_cols, "L4", "L3")
        L3_to_L2 = conditional_probabilities(df, L3_cols, L2_cols, "L3", "L2")
        L2_to_L1 = conditional_probabilities(df, L2_cols, L1_cols, "L2", "L1")
